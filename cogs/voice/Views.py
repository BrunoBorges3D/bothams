...
class Views():
    ...
    class UserSelector(discord.ui.View):
        ...
        @discord.ui.select(placeholder="Select something to do with this user",
                            options=[discord.SelectOption(label="Disconnct", description="Disconnect the user from this channel", value="disconnect"),
                                    ...
                                    discord.SelectOption(label="Transfer Owner", description="Transfer ownership of this channel", value="transfer")
                                ]
                            )
            ...
            try:
                ...
                if selected == "transfer":
                    ...
                    async def confirm_callback(btn_interaction: discord.Interaction):
                        ...
                        try:
                            # Remove old owner
                            await db.delete_channel(self.user.id, interaction.channel_id, interaction.guild_id)
                            # Add new owner
                            await db.create_channel(self.edit_user.id, interaction.channel_id, interaction.guild_id)
                            # Update channel name
                            await interaction.channel.edit(name=f"{self.edit_user.display_name}'s Voice")
                            
                            # Send transfer log
                            log_embed = Embeds.LogEmbed("transfer", old_owner=self.user, new_owner=self.edit_user)
                            await interaction.channel.send(embed=log_embed, allowed_mentions=discord.AllowedMentions.none())
                            
                            await btn_interaction.followup.send(
                                f"Channel ownership has been transferred to {self.edit_user.mention}!", 
                                ephemeral=True
                            )
                        except Exception as e:
                            await btn_interaction.followup.send(
                                f"Failed to transfer ownership: {str(e)}", 
                                ephemeral=True
                            )

                    async def cancel_callback(btn_interaction: discord.Interaction):
                        await btn_interaction.response.defer()
                        await btn_interaction.followup.send("Transfer cancelled!", ephemeral=True)
                    ...
                    try:
                        await interaction.followup.send(
                            f"Are you sure you want to transfer channel ownership to {self.edit_user.mention}?",
                            view=view,
                            ephemeral=True
                        )
                    except discord.NotFound:
                        print("Failed to send followup: Interaction not found")
                    except Exception as e:
                ...
                print(f"Error in edit member callback: {str(e)}")
                try:
    ...
    class Dropdown(discord.ui.View):
        ...
        async def activites_callback(self, select: discord.ui.Select, interaction: discord.Interaction):
            ...
            return await interaction.respond(f"The User {interaction.user.mention} Has Created This Activity Invite_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍_‍{invite}")
            #                                                                                                      ^^^^^^^ discord ☕
    ...
    class TransferOnLeave(discord.ui.View):
        def __init__(self, owner: discord.Member, channel_id: int, guild_id: int):
            super().__init__(timeout=300)  # 5 minutes timeout
            self.owner = owner
            self.channel_id = channel_id
            self.guild_id = guild_id

        @discord.ui.button(label="Become Owner", style=discord.ButtonStyle.primary)
        async def transfer_button(self, button: discord.ui.Button, interaction: discord.Interaction):
            if not interaction.user.voice or interaction.user.voice.channel.id != self.channel_id:
                return await interaction.response.send_message("You must be in this voice channel to become owner!", ephemeral=True)
            
            try:
                # Transfer ownership
                await db.delete_channel(self.owner.id, self.channel_id, self.guild_id)
                await db.create_channel(interaction.user.id, self.channel_id, self.guild_id)
                
                # Update channel name
                channel = interaction.channel
                await channel.edit(name=f"{interaction.user.display_name}'s Voice")
                
                # Send transfer log
                log_embed = Embeds.LogEmbed("transfer", old_owner=self.owner, new_owner=interaction.user)
                await interaction.channel.send(embed=log_embed, allowed_mentions=discord.AllowedMentions.none())
                ...
                await interaction.response.send_message(f"You are now the owner of this channel!", ephemeral=True)
            except Exception as e:
                await interaction.response.send_message(f"Failed to transfer ownership: {str(e)}", ephemeral=True)
